...
namespace Robots_vs_Dinosaurs
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            battlefield.PlayAGame();
        }
    }
}
//DONE
//(5points):As a developer, I want to make good, consistent commits.
//(5points):As a developer, I want to make a class for each of the following: Robot, Dinosaur, Fleet, Herd, Weapon, Battlefield.
//(10points):As a developer, I want a Dinosaur to have a type, health, energy, and attack power.
//(10points):As a developer, I want to instantiate three Robot objects and three Dinosaur objects and assign the appropriate values to all the objects. 
//(10points):As a developer, I want the created Robot objects to be stored in a Fleet and the created Dinosaur objects to be stored in a Herd.
